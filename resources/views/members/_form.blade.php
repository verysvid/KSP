...
<div class="grid grid-cols-1 gap-5 md:grid-cols-2">
    ...
    <div>
        ...
        @else
            <select
                ...
                class="form-select cursor-not-allowed opacity-80"
                disabled
            >
                <option selected>
            ...
            @foreach($memberTypes as $memberType)
                <option
                    ...
                    @selected(
                        (string) old(
                            'member_type_id',
                            isset($member) ? $member->member_type_id : ''
                        ) === (string) $memberType->id
                    )
                >
                    {{ $memberType->name }}
                </option>
    ...
    <div>
        ...
        >
            ...
            <option
                value="L"
                @selected(old('gender', $member->gender ?? '') === 'L')
            >
                Laki-laki
            </option>
            <option
                value="P"
                @selected(old('gender', $member->gender ?? '') === 'P')
            >
                Perempuan
            </option>
        </select>
    ...
    <div>
        ...
        <input
            ...
            value="{{ old(
                'birth_date',
                isset($member) && $member->birth_date
